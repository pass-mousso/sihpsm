...
final class Version20241208122212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hospital ADD city_id INT NOT NULL');
        $this->addSql('ALTER TABLE hospital ADD region_id INT NOT NULL');
        $this->addSql('ALTER TABLE hospital ADD country_id INT NOT NULL');
        $this->addSql('ALTER TABLE hospital ADD name VARCHAR(150) NOT NULL');
        ...
        $this->addSql('ALTER TABLE hospital ADD CONSTRAINT FK_8718F2CC54C8C93 FOREIGN KEY (type_id) REFERENCES hopital_facility (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE hospital ADD CONSTRAINT FK_8718F2C8BAC62AF FOREIGN KEY (city_id) REFERENCES city (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE hospital ADD CONSTRAINT FK_8718F2C98260155 FOREIGN KEY (region_id) REFERENCES region (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE hospital ADD CONSTRAINT FK_8718F2CF92F3E70 FOREIGN KEY (country_id) REFERENCES country (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_8718F2CC54C8C93 ON hospital (type_id)');
        $this->addSql('CREATE INDEX IDX_8718F2C8BAC62AF ON hospital (city_id)');
        $this->addSql('CREATE INDEX IDX_8718F2C98260155 ON hospital (region_id)');
        $this->addSql('CREATE INDEX IDX_8718F2CF92F3E70 ON hospital (country_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hospital DROP CONSTRAINT FK_8718F2CC54C8C93');
        $this->addSql('ALTER TABLE hospital DROP CONSTRAINT FK_8718F2C8BAC62AF');
        $this->addSql('ALTER TABLE hospital DROP CONSTRAINT FK_8718F2C98260155');
        $this->addSql('ALTER TABLE hospital DROP CONSTRAINT FK_8718F2CF92F3E70');
